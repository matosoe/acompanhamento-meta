...
public final class WeeklyTableAdapter extends RecyclerView.Adapter<WeeklyTableAdapter.Holder> {
    ...
    public void submit(List<String> values, List<Integer> indexes) { rows.clear(); rows.addAll(values); weekIndexes.clear(); weekIndexes.addAll(indexes); notifyDataSetChanged(); }
